...
-- Source of truth: src/db/migrations/0039_audit_fk_references.sql (72 audit columns).
--
-- Expected output: total_orphans = 0 and the orphan-detail result set is empty.
-- Any non-zero orphan count is a hard deploy blocker for migration 0039 — VALIDATE
-- CONSTRAINT would abort the migration transaction and leave the schema unchanged.
--
-- Re-run this script verbatim pre-deploy and post-deploy of PR 1.
-- Usage: psql "$DATABASE_URL" -f .compozy/tasks/audit-user-references/scripts/orphan-audit.sql
--
...
CREATE TEMP VIEW audit_refs AS
  ...
  UNION ALL SELECT 'absences', 'deleted_by', deleted_by FROM absences WHERE deleted_by IS NOT NULL
  ...
  UNION ALL SELECT 'accidents', 'deleted_by', deleted_by FROM accidents WHERE deleted_by IS NOT NULL
  ...
  UNION ALL SELECT 'admin_org_provisions', 'deleted_by', deleted_by FROM admin_org_provisions WHERE deleted_by IS NOT NULL
  ...
  UNION ALL SELECT 'billing_profiles', 'deleted_by', deleted_by FROM billing_profiles WHERE deleted_by IS NOT NULL
  ...
  UNION ALL SELECT 'branches', 'deleted_by', deleted_by FROM branches WHERE deleted_by IS NOT NULL
  ...
  UNION ALL SELECT 'cost_centers', 'deleted_by', deleted_by FROM cost_centers WHERE deleted_by IS NOT NULL
  ...
  UNION ALL SELECT 'cpf_analyses', 'deleted_by', deleted_by FROM cpf_analyses WHERE deleted_by IS NOT NULL
  ...
  UNION ALL SELECT 'employees', 'deleted_by', deleted_by FROM employees WHERE deleted_by IS NOT NULL
  ...
  UNION ALL SELECT 'job_classifications', 'deleted_by', deleted_by FROM job_classifications WHERE deleted_by IS NOT NULL
  ...
  UNION ALL SELECT 'job_positions', 'deleted_by', deleted_by FROM job_positions WHERE deleted_by IS NOT NULL
  ...
  UNION ALL SELECT 'labor_lawsuits', 'deleted_by', deleted_by FROM labor_lawsuits WHERE deleted_by IS NOT NULL
  ...
  UNION ALL SELECT 'medical_certificates', 'deleted_by', deleted_by FROM medical_certificates WHERE deleted_by IS NOT NULL
  ...
  UNION ALL SELECT 'organization_profiles', 'deleted_by', deleted_by FROM organization_profiles WHERE deleted_by IS NOT NULL
  ...
  UNION ALL SELECT 'ppe_deliveries', 'deleted_by', deleted_by FROM ppe_deliveries WHERE deleted_by IS NOT NULL
  UNION ALL SELECT 'ppe_delivery_items', 'created_by', created_by FROM ppe_delivery_items WHERE created_by IS NOT NULL
  UNION ALL SELECT 'ppe_delivery_items', 'deleted_by', deleted_by FROM ppe_delivery_items WHERE deleted_by IS NOT NULL
  ...
  UNION ALL SELECT 'ppe_items', 'deleted_by', deleted_by FROM ppe_items WHERE deleted_by IS NOT NULL
  UNION ALL SELECT 'ppe_job_positions', 'created_by', created_by FROM ppe_job_positions WHERE created_by IS NOT NULL
  UNION ALL SELECT 'ppe_job_positions', 'deleted_by', deleted_by FROM ppe_job_positions WHERE deleted_by IS NOT NULL
  UNION ALL SELECT 'project_employees', 'created_by', created_by FROM project_employees WHERE created_by IS NOT NULL
  UNION ALL SELECT 'project_employees', 'deleted_by', deleted_by FROM project_employees WHERE deleted_by IS NOT NULL
  ...
  UNION ALL SELECT 'projects', 'deleted_by', deleted_by FROM projects WHERE deleted_by IS NOT NULL
  ...
  UNION ALL SELECT 'promotions', 'deleted_by', deleted_by FROM promotions WHERE deleted_by IS NOT NULL
  ...
  UNION ALL SELECT 'sectors', 'deleted_by', deleted_by FROM sectors WHERE deleted_by IS NOT NULL
  ...
  UNION ALL SELECT 'terminations', 'deleted_by', deleted_by FROM terminations WHERE deleted_by IS NOT NULL
  ...
  UNION ALL SELECT 'vacations', 'deleted_by', deleted_by FROM vacations WHERE deleted_by IS NOT NULL
  ...
  UNION ALL SELECT 'warnings', 'deleted_by', deleted_by FROM warnings WHERE deleted_by IS NOT NULL;
...
\echo ''
\echo '=== Totals (baseline 2026-04-21 on prod: total_refs=930, total_orphans=0) ==='
SELECT
  COUNT(*)::bigint AS total_refs,
