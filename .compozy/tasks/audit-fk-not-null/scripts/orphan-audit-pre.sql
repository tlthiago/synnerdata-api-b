...
-- partially altered.
--
-- Re-run this script verbatim pre-deploy of PRD #3 PR. After deploy, switch to
-- orphan-audit-post.sql (no deleted_by UNION lines) for the G3 post-deploy check.
-- Usage: psql "$DATABASE_URL" -f .compozy/tasks/audit-fk-not-null/scripts/orphan-audit-pre.sql
--
