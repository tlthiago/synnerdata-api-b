...
| 🟡 **Curto prazo** (hardening, 30-90d) | 50 | 39 | 7 | **78%** · 3 reclassificadas para MP (CP-18→MP-24, CP-19→MP-25 em 2026-04-23; CP-44→MP-27 em 2026-04-24) · Onda 6 + CP-38 + #269 parcial + CP-48 (Zod 4.3) + CP-47 (Better Auth 1.6) entregues 2026-04-24 |
...
3. **Onda 7 seq** (~~CP-48~~ → ~~CP-47~~ → CP-46 → 50) — tooling migrations por ordem de risco crescente: ~~Zod 4.3 ✅~~ → ~~Better Auth 1.6 ✅~~ → Ultracite 7 → TS 6. Cada PR dedicado.
