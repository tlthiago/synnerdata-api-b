...
| **3. Execução** | 🔄 Em execução | 2026-04-22 | **Bucket 🔴 concluído (10/10)**. Bucket 🟡 **Ondas 1/2/3 quase completas + Onda 5 em andamento** (CP-1 XL + CP-4 L + CP-33 S + CP-26 S + CP-28 S + CP-32 M + CP-5 L entregues). Total concluídas no 🟡: **30 CPs** (CP-1, CP-4, CP-5, CP-7, CP-8, CP-9, CP-13, CP-20, CP-21, CP-22, CP-23, CP-24, CP-25, CP-26, CP-27, CP-28, CP-29, CP-30, CP-31, CP-32, CP-33, CP-34, CP-35, CP-36, CP-37, CP-39, CP-40, CP-42, CP-43, CP-45). Resta **CP-41** (Onda 3 PR-D). CP-5 consolida erros de domínio em `modules/<domínio>/errors.ts`, dedup de `FeatureNotAvailableError`/`NoActiveOrganizationError`, e factory `errorSchema(code)` em responses. Remaining next-up: CP-6 (M HMAC Pagar.me), CP-3 (L routes v1), CP-2 (XL emails). Débito #96 100% endereçado. |
